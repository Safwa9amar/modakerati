export default {
  ...
  select_services_desc:
    'Choose the services you need: TOC, pagination, references, formatting...',
  confirm_services: 'Confirm Services',
  review_settings: 'Review & Confirm Settings',
  review_settings_desc:
    'Review your project summary and edit options if needed.',
  start_processing: 'Start Processing',
  processing_progress: 'Processing Progress',
  processing_progress_desc:
    'Track real-time progress with a smooth progress bar.',
  download_preview: 'Download & Preview Results',
  download_preview_desc:
    'Download the formatted document or preview it in-app. Congrats!',
  download_result: 'Download Result',
  freelance_marketplace_optional: 'Freelance Marketplace (Optional)',
  freelance_marketplace_optional_desc:
    'Propose your project to expert freelancers for extra improvements.',
  ...
  search: 'Search',
  'Please provide file details:': 'Please provide file details:',
  upload_file_desc:
    'Note: If the thesis is divided into multiple files and chapters, please press on the selected file to add details and notes related to each file.',
  
  // Thesis Details Section
  thesis_details: 'Thesis Details',
  thesis_details_desc: 'Please provide the basic information about your thesis',
  thesisTitle: 'Thesis Title',
  thesisDescription: 'Thesis Description',
  thesisSubject: 'Thesis Subject',
