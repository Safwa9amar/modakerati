...
export const TERMS: Record<Lang, LegalDoc> = {
  ...
  ar: {
    ...
    intro:
      "مرحبًا بك في Kwill. بإنشائك حسابًا أو باستخدامك التطبيق فإنك توافق على شروط الاستخدام هذه. يُرجى قراءتها بعناية.",
    sections: [
      {
        heading: "١. الخدمة",
        body: [
          "Kwill أداة كتابة مدعومة بالذكاء الاصطناعي تساعد الطلبة على هيكلة المذكرات والأطروحات وصياغتها وتنسيقها. تقدّم الأداة اقتراحات وأدوات تنسيق، لكنها لا تكتب عملك نيابةً عنك ولا تضمن أي نتيجة أكاديمية.",
        ],
      },
      {
        heading: "٢. حسابك",
      ...
      },
      {
        ...
        body: [
          ...
          "تلتزم باتباع قواعد جامعتك بشأن الانتحال والاقتباس والاستخدام المسموح به لأدوات الذكاء الاصطناعي. Kwill وسيلة مساعدة على الكتابة وليست بديلًا عن مجهودك العلمي.",
        ],
      },
      {
        heading: "٤. محتواك",
...
export const PRIVACY: Record<Lang, LegalDoc> = {
  ...
  ar: {
    updated: "آخر تحديث: جوان 2026",
    intro:
      "توضّح سياسة الخصوصية هذه البيانات التي يجمعها تطبيق Kwill وأسباب جمعها والخيارات المتاحة لك. نحن نجمع فقط ما نحتاجه لتشغيل التطبيق.",
    sections: [
      {
