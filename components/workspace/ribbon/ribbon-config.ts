...
export const RIBBON_TABS: RibbonTabDef[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "ref.caption", tab: "references", group: "ribbon.grp.captions", labelKey: "ribbon.tools.caption", icon: "caption", kind: "action", status: "wired", actionKey: "ref.caption", keywords: ["caption"] },
      { id: "ref.figuresList", tab: "references", group: "ribbon.grp.captions", labelKey: "ribbon.tools.figuresList", icon: "figuresList", kind: "action", status: "wired", actionKey: "ref.figuresList", keywords: ["list of figures"] },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "picture.caption", tab: "picture", group: "ribbon.grp.picture", labelKey: "ribbon.tools.caption", icon: "caption", kind: "action", status: "wired", actionKey: "picture.caption", keywords: ["caption"] },
    ],
  },
];
